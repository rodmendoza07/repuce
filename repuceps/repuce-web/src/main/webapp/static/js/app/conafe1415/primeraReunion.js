...
//********************************* Termina actividad 4 y 5
		...
		function _popupNumeroDeAlumnos(itemToEdit){
			...
			var txtNinos = new ValidationTextBox({
				...
				maxLength : "2",
				placeHolder : "Nota: agregar n\u00famero de alumnos hombres",
				regExp : constants.NUMBER_VALID,
				required : true,
	            style : "width:200px;"
			},'txtNinos');
			...
			var txtNinas = new ValidationTextBox({
				...
				maxLength : "2",
				placeHolder : "Nota: agregar n\u00famero de alumnos mujeres",
				regExp : constants.NUMBER_VALID,
				required : true,
	            style : "width:200px;"
			},'txtNinas');
...
/*	 			if	(registry.byId(('cmbAlimen50').getValue() == "SI" ||
	 					registry.byId('cmbAlimen52').getValue() == "SI" ||
	 					registry.byId('cmbAlimen54').getValue() == "SI") &&
	 					registry.byId('cmbIntApecAA56').getValue() == ""){			
