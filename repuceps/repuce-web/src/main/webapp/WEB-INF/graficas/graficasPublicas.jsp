 ...
 function( ready,reportesPublicConstant,Button, dom, domClass, Source,CheckedMultiSelect,
 	...
 	ready(function(){
	 	...
	 	on( dom.byId('grafica3'),'click', function(){
	 		...
	 		var col =  ["Fomento de actividades relacionadas con la lectura y aprovechamiento de la infraestructura disponible para ello ","De mejoramiento de la infraestructura (NO relacionado con el programa Escuela Digna).","Rehabilitación de planteles escolares 'Escuelas Dignas'","Protección civil y de seguridad de las escuelas.","Impulso a la activación física.","Actividades recreativas, artísticas o culturales.","Desaliento de las prácticas que generen violencia.","Establecimiento de consumo escolar.","Cuidado al medio ambiente y limpieza del entorno escolar.","Alimentación saludable.","Integración educativa.","Nuevas tecnologías.","Contraloría social","Otro"]; 
	 	...
	 	on( dom.byId('grafica4'),'click', function(){
	 		...
	 		//var col = ["Primera Asamblea","Primera Sesión","Segunda Sesión","Segunda Asamblea","Tercera Sesión","Cuarta Sesión","Tercera Asamblea"];
...
// 	 		//var col = ['Director','Padre de Familia','Representante de la Asociación de Padres de Familia', 'Maestro', 'Miembro de la comunidad', 'Representante de Asociación Sindical','Alumno', 'Exalumno'];
// 	 		var cat = ['calidad_presidente'];
// 	 		var col = ['Padre de Familia o Representante de la Asociación de Padres de Familia'];
...
// 	 		var col = ['Compromisos de diagnóstico y seguimiento','Compromisos en el cumplimiento de metas','Corresponsabilidad de madres y padres de familia', 'Cursos y tareas extras', 'Estímulos y reconocimiento al mejoramiento del desempeño global y grupal', 'Capacitación y apoyo docente'];
	...
	<table align="center" style="width: 45%;">
	    <tr>
	        <td style="width: 50%;  align: center;"><br>
	        	<h2 style="text-align: center;"><font color="black">Listado de Gráficas Públicas</font></h2>
	        <br><br></td>
		</tr>
		<tr>
	        <td style="width: 50%;"><br>
	        	&Phi; <a href="#" id="grafica1"><font color="black">Gráfica de avance de instalación por nivel educativo </font></a>
	        <br><br></td>
		</tr>
		<tr>
	        <td style="width: 50%;">
	        	&Phi; <a href="#" id="grafica2"><font color="black">Gráfica de avance de instalación por sostenimiento</font></a>
	        <br/><br></td>
		</tr>
		<tr>
	        <td style="width: 50%;">
	        	&Phi; <a href="#" id="grafica3"><font color="black">Gráfica de instalación de comités</font></a>
	        <br><br></td>
		</tr>
		<tr>
	        <td style="width: 50%;">
	        	&Phi; <a href="#" id="grafica4"><font color="black">Gráfica de avance de sesiones y asambleas</font></a>
	        <br><br></td>
		</tr>
<!-- 		<tr> -->
<!-- 	        <td style="width: 50%;"> -->
<!-- 	        	&Phi; <a href="#" id="grafica5"><font color="black">Gráfica de Calidad del Presidente del Consejo Escolar</font></a> -->
<!-- 	        <br><br></td> -->
<!-- 		</tr> -->
		<tr>
	        <td style="width: 50%;">
	        	&Phi; <a href="#" id="grafica6"><font color="black">Gráfica de Calidad del Secretario Técnico del Consejo Escolar</font></a>
	        <br><br></td>
		</tr>
		<tr>
	        <td style="width: 50%;">
	        	&Phi; <a href="#" id="grafica7"><font color="black">Gráfica de Avance en el Registro de Consejos Escolares en el ámbito Urbano y Rural</font></a>
	        <br><br></td>
		</tr>
		<tr>
	        <td style="width: 50%;">
	        	&Phi; <a href="#" id="grafica8"><font color="black">Gráfica de Avance por Zonas Geográficas</font></a>
	        <br><br></td>
		</tr>
<!-- 		<tr> -->
<!-- 	        <td style="width: 50%;"> -->
<!-- 	        	&Phi; <a href="#" id="grafica9"><font color="black">Gráfica de Consejos que revisaron los resultados de ENLACE</font></a> -->
<!-- 	        <br><br></td> -->
<!-- 		</tr> -->
<!-- 		<tr> -->
<!-- 	        <td style="width: 50%;"> -->
<!-- 	        	&Phi; <a href="#" id="grafica10"><font color="black">Gráfica por tipo de compromisos registrados</font></a> -->
<!-- 	        <br><br><br><br></td> -->
<!-- 		</tr> -->
		<tr>
	    <td>
