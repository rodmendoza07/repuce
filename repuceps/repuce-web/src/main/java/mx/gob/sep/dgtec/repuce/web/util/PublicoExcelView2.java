...
public class PublicoExcelView2 extends AbstractExcelView {  
        ...
        for (CCctCstm cct : cCcts) { 
        	row++;
   			...
   			getCell(sheet, row, 9).setCellValue(  
   		 	...
   		 	getCell(sheet, row, 11).setCellValue(  
	          		(String)cct.getPrograma());
   		 	getCell(sheet, row, 12).setCellValue(
   		 		cct.getMonto().toString());
