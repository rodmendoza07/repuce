...
/**
 * Implementacion de {@link ServicioNotificacion} que publica la informacion por medio
 * de slf4j.
 * 
 * Se recomienda usar configuracion asíncrona del logger para no afectar el desempeño de la
 * aplicacion. 
 *
