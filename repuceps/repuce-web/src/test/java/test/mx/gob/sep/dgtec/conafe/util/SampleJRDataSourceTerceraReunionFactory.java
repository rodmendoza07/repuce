...
public class SampleJRDataSourceTerceraReunionFactory {
	...
	public static Vector<ReunionesConafeVO> createBeanCollection() {
		...
		regCat1.setDescripLargar3("Organización y acuerdos de la comunidad para garantizar la alimentación y el hospedaje");
		...
		accion5.setRespuestaR3("Sí");

		CAccion regCat5 = new CAccion();
		regCat5.setcAccion(4);
		regCat5.setcTipoAccion(Constants.C_TIPO_ACCION_PERMANENCIA);
		regCat5.setDescripLargar3("Se ha integrado la información familiar y antecedentes médicos de los instructores comunitarios en caso de cualquier emergencia.");
		...
		regCat3.setDescripLargar3("Número de jornadas efectuadas para dar mantenimiento al mobiliario escolar.");
		...
		regDes1.setPreguntaLarga("Número de instructores comunitarios que desertaron durante el ciclo escolar.");
		...
		regDes2.setPreguntaLarga("Número de alumnos que abandonaron la escuela durante este ciclo escolar.");
		...
		preg1.setNombreActividad("Se llevó a cabo el inventario de mobiliario y materiales didácticos.");
